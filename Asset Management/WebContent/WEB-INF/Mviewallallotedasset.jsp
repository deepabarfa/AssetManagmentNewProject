...
<center>
<h1>My Employee alloted Assets</h1>
...
%>
<tr> 
<form action="./MTransferRequest" method="post">
    ...
    <input type="hidden" name="mid1" value="<%=cc.getMid1()%>" />
     <input type="hidden" name="mid2" value="<%=cc.getMid1()%>" />
...
{
%> 
     <td><input type="hidden" value="Request For Transfer "></td>
     <%
}
else
{
