...
<table cellpadding="10" cellspacing="10" height="50%" width="30%">
 ...
 <tr><td><b>Name</b></td><td><input type="text" name="name"  id="name1" required/></td></tr>
 ...
 <tr><td><b>Designation</b></td><td><select  id="empDes" name="designation"  required="required" onblur="return validate()">
                     ...
                     <tr id="Employee"><td>
<b>EMPLOYEE ID</b>          </td><td><input type="text" name="eid1" id="eid111" pattern="[E]{1}\d{3}" value="E100" placeholder="E101"  maxlength="15" required="required" />
                     </td></tr>
                     <tr id="Manager"><td>
